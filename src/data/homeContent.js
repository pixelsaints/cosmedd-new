...
export const slides = [
  ...
  },
  {
    ...
    primary: "Global Presence",
    secondary: "Start Partnership",
    primaryUrl: "/global-presence",
    secondaryUrl: "/contact",
    image: "/images/sourcing-solutions.webp",
  },
];

export const whyCosmeddData = {
  left: [
    {
      number: "01",
    ...
    },
    {
      ...
      desc: "Solutions aligned with global pharmaceutical regulations and export documentation requirements.",
      icon: "/icons/regulatory-compliance.svg",
    },
    {
      number: "05",
      title: "Competitive market pricing",
      desc: "Cost-effective healthcare solutions without compromising product quality or reliability.",
      icon: "/icons/competitive-market-pricing.svg",
    },
  ],
  ...
  right: [
    {
      ...
      desc: "Every product undergoes strict quality checks to meet international healthcare standards.",
      icon: "/icons/quality-assured-products.svg",
    },
    {
      number: "04",
    ...
    },
    {
      ...
      desc: "Building sustainable global business relationships through trust, consistency, and transparency.",
      icon: "/icons/long-term-partnerships.svg",
    },
  ],
